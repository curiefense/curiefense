...
CURIECONF_TRUSTED_USERNAME_HEADER = os.environ.get("CURIECONF_TRUSTED_USERNAME_HEADER", "")
...
GOOGLE_APPLICATION_CREDENTIALS= os.environ.get("GOOGLE_APPLICATION_CREDENTIALS", "/var/run/secrets/gs/gs.json")

SWAGGER_BASE_PATH = os.environ.get("SWAGGER_BASE_PATH", "/api/v3/")

AUDIT_LOGS_RETENTION_MONTHS = os.environ.get("AUDIT_LOGS_RETENTION_MONTHS", "3")
