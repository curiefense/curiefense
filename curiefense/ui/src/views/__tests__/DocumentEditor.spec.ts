...
import {ACLPolicy, Branch, Commit, FlowControl, RateLimit, GlobalFilter, URLMap, ContentFilterProfile} from '@/types'
...
describe('DocumentEditor.vue', () => {
  ...
  describe('buttons', () => {
    ...
    test('should not be able to delete an Content Filter Profile document if it is referenced by a url map', async () => {
