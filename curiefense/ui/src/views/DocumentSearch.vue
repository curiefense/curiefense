...
export default Vue.extend({
  ...
  data() {
    ...
    // Order is important
    // We load [securitypolicies] before [aclpolicies, wafpolicies, ratelimits] so we can pull all references correctly
    const componentsMap: {
      [key in DocumentType]?: {
    ...
    return {
      ...
      // Referenced IDs of [aclpolicies, wafpolicies, ratelimits] in [securitypolicies]
