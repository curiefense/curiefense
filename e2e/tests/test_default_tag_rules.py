...
from e2e.helpers.tag_rule_default_helper import (
    tagrules_config,
    active,
    TagRulesDefaultHelper,
)
...
class TestTagRuleDefault:
    ...
    def test_cookie_with_default_action(self, target):
        ...
        TagRulesDefaultHelper.tag_rules_action_503_with_params(
            target, "/e2e-tagrule-cookie", params
        )
    ...
    def test_method_with_default_action(self, target):
        ...
        TagRulesDefaultHelper.tag_rules_action_503_with_params(
            target, "/e2e-tagrules-post", params
        )
