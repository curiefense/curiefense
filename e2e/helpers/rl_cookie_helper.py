...
class RateLimitCookieHelper:
    ...
    def gen_rl_rules(authority):
        ...
        add_rl_rule(
            ...
            ttl=4,
            limit=2,
            pairwith=({"cookies": "cookie_event_ban_chl_authority"}),
            action_ext=({"type": "ban"}),
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=4,
            pairwith=({"cookies": "cookie_event_ban_red_uri"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=4,
            pairwith=({"cookies": "cookie_event_ban_red_query"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=4,
            pairwith=({"cookies": "cookie_event_ban_red_path"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=4,
            pairwith=({"cookies": "cookie_event_ban_red_method"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=4,
            pairwith=({"cookies": "cookie_event_ban_red_company"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=4,
            pairwith=({"cookies": "cookie_event_ban_red_authority"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
