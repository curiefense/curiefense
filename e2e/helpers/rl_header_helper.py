...
class RateLimitHeaderHelper:
    ...
    def gen_rl_rules(authority):
        ...
        add_rl_rule(
            path="test_tag_header_ip",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_ip"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "ip"}]
        ),
        add_rl_rule(
            path="test_tag_header_asn",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_asn"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "asn"}]
        ),
        add_rl_rule(
            path="test_tag_header_uri",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_uri"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "uri"}]
        ),
        add_rl_rule(
            path="test_tag_header_path",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_path"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "path"}]
        ),
        add_rl_rule(
            path="test_tag_header_query",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_query"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "query"}]
        ),
        add_rl_rule(
            path="test_tag_header_method",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_method"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "method"}]
        ),
        add_rl_rule(
            path="test_tag_header_company",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_company"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "company"}]
        ),
        add_rl_rule(
            path="test_tag_header_country",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_country"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "country"}]
        ),
        add_rl_rule(
            path="test_tag_header_authority",
            ttl=20,
            limit=1,
            pairwith=({"headers": "header_event_tag_authority"}),
            action_ext=({"type": "monitor"}),
            key=[{"attrs": "authority"}]
        ),
        ...
        add_rl_rule(
            path="test_challenge_header_ip",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_ip"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "ip"}]
        ),
        add_rl_rule(
            path="test_challenge_header_uri",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_uri"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "uri"}]
        ),
        add_rl_rule(
            path="test_challenge_header_query",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_query"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "query"}]
        ),
        add_rl_rule(
            path="test_challenge_header_path",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_path"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "path"}]
        ),
        add_rl_rule(
            path="test_challenge_header_method",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_method"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "method"}]
        ),
        add_rl_rule(
            path="test_challenge_header_asn",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_asn"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "asn"}]
        ),
        add_rl_rule(
            path="test_challenge_header_company",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_company"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "company"}]
        ),
        add_rl_rule(
            path="test_challenge_header_country",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_country"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "country"}]
        ),
        add_rl_rule(
            path="test_challenge_header_authority",
            ttl=4,
            limit=5,
            pairwith=({"headers": "header_event_chl_authority"}),
            action_ext=({"type": "challenge"}),
            key=[{"attrs": "authority"}]
        ),

        add_rl_rule(
            path="test_redirect_header_ip",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_ip"}),
        ...
        add_rl_rule(
            path="test_redirect_header_uri",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_uri"}),
            action_ext=({"type": "redirect"}),
            param_ext={"status": "200", "location": "https://yahoo.com"},
            key=[{"attrs": "uri"}]
        ),
        ...
        add_rl_rule(
            path="test_redirect_header_query",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_query"}),
            action_ext=({"type": "redirect"}),
            param_ext={"status": "200", "location": "https://yahoo.com"},
            key=[{"attrs": "query"}]
        ),
        add_rl_rule(
            path="test_redirect_header_path",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_path"}),
            action_ext=({"type": "redirect"}),
            param_ext={"status": "200", "location": "https://yahoo.com"},
            key=[{"attrs": "path"}]
        ),
        add_rl_rule(
            path="test_redirect_header_asn",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_asn"}),
            action_ext=({"type": "redirect"}),
            param_ext={"status": "200", "location": "https://yahoo.com"},
            key=[{"attrs": "asn"}]
        ),
        add_rl_rule(
            path="test_redirect_header_method",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_method"}),
            action_ext=({"type": "redirect"}),
            param_ext={"status": "200", "location": "https://yahoo.com"},
            key=[{"attrs": "method"}]
        ),
        add_rl_rule(
            path="test_redirect_header_company",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_company"}),
            action_ext=({"type": "redirect"}),
            param_ext={"status": "200", "location": "https://yahoo.com"},
            key=[{"attrs": "company"}]
        ),
        add_rl_rule(
            path="test_redirect_header_country",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_country"}),
            action_ext=({"type": "redirect"}),
            param_ext={"status": "200", "location": "https://yahoo.com"},
            key=[{"attrs": "country"}]
        ),
        add_rl_rule(
            path="test_redirect_header_authority",
            ttl=3,
            limit=3,
            pairwith=({"headers": "header_event_red_authority"}),
            action_ext=({"type": "redirect"}),
            param_ext={"status": "200", "location": "https://yahoo.com"},
            key=[{"attrs": "authority"}]
        ),
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_ip",
            ttl=5,
            limit=5,
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_uri",
            ttl=5,
            limit=5,
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_query",
            ttl=5,
            limit=5,
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_path",
            ttl=5,
            limit=5,
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_method",
            ttl=5,
            limit=5,
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_company",
            ttl=5,
            limit=5,
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_country",
            ttl=5,
            limit=5,
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_asn",
            ttl=5,
            limit=5,
        ...
        add_rl_rule(
            path="test_ban_header_sub_chl_count_by_authority",
            ttl=5,
            limit=5,
            pairwith=({"headers": "header_event_ban_chl_authority"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(6)},
            subaction="challenge",
            key=[{"attrs": "authority"}]
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_ip",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_uri",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_query",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_path",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_asn",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_method",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_company",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_country",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_tag_count_by_authority",
            ttl=20,
            limit=1,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_ip",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_uri",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_query",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_path",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_asn",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_method",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_company",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_country",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            path="test_ban_header_sub_response_count_by_authority",
            ttl=2,
            limit=3,
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=5,
            pairwith=({"headers": "header_event_ban_red_path"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=5,
            pairwith=({"headers": "header_event_ban_red_query"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=5,
            pairwith=({"headers": "header_event_ban_red_uri"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=5,
            pairwith=({"headers": "header_event_ban_red_method"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=5,
            pairwith=({"headers": "header_event_ban_red_company"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
        ...
        add_rl_rule(
            ...
            ttl=2,
            limit=5,
            pairwith=({"headers": "header_event_ban_red_authority"}),
            action_ext=({"type": "ban"}),
            param_ext={"duration": str(4)},
            subaction="redirect",
            subaction_params={"status": "200", "location": "https://google.com"},
...
def ratelimit_header_config(cli, target, api_config):
    ...
    (new_rules, new_urlmap) = RateLimitHeaderHelper.gen_rl_rules(target.authority())
